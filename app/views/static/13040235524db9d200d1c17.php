<div class="l-static-wrap">
					<div class="b-static m-justify">
						...
						<p style="text-align:right;padding-right:10px;">
							...
							<input type="button" value="Отправить" onclick="var i=new Image();i.onload=function(){alert('Ваша ссылка принята в обработку, спасибо!');};i.onerror=function(){alert('Произошла ошибка, возможно ссылка уже была отправлена, либо вы отправили слишком много ссылок.');};i.src='http://1chna.ru/service/share/?link='+encodeURIComponent($('#share_link').val().replace(/#(.*)$/,''))+'&description='+encodeURIComponent($('#share_desc').val())+'&title='+encodeURIComponent('Отправлено через форму');$('#share_desc, #share_link').val('');" />
						</p>
						<p>
						...
						<p>
							...
							завести джаббер и посетить конференцию <em>press@conference.1chna.ru</em>. 
						</p>
						<p>
						...
						<p>
							...
							может быть получен Jabber ID на сервере 1chna.ru, для внутреннего пользования.
						</p>
						<p>
							Если у вас есть желание помочь Одинчану, упорство и немного самоотдачи, то милости просим
							в конференцию <em>press@conference.1chna.ru</em>.
						</p>
					</div>
				</div> 
