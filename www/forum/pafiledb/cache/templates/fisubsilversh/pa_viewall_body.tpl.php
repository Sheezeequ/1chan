...
<table width="100%" cellpadding="2" cellspacing="2">
  <tr>
	<td valign="bottom">
		<span class="nav"><a href="<?php echo $this->_tpldata['.'][0]['U_INDEX']; ?>" class="nav"><?php echo ((isset($this->_tpldata['.'][0]['L_INDEX'])) ? $this->_tpldata['.'][0]['L_INDEX'] : ((isset($lang['INDEX'])) ? $lang['INDEX'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'INDEX'))) . ' 	}')); ?></a> &raquo; <a href="<?php echo $this->_tpldata['.'][0]['U_DOWNLOAD']; ?>" class="nav"><?php echo $this->_tpldata['.'][0]['DOWNLOAD']; ?></a> &raquo; <?php echo ((isset($this->_tpldata['.'][0]['L_VIEWALL'])) ? $this->_tpldata['.'][0]['L_VIEWALL'] : ((isset($lang['VIEWALL'])) ? $lang['VIEWALL'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'VIEWALL'))) . ' 	}')); ?></span>
	</td>
  </tr>
</table>
