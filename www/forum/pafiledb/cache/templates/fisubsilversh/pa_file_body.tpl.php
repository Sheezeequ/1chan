...
<?php if ($this->_tpldata['.'][0]['AUTH_EDIT']) {  ?>  
		<a href="<?php echo $this->_tpldata['.'][0]['U_EDIT']; ?>"><img src="<?php echo $this->_tpldata['.'][0]['EDIT_IMG']; ?>" border="0" alt="<?php echo ((isset($this->_tpldata['.'][0]['L_EDIT'])) ? $this->_tpldata['.'][0]['L_EDIT'] : ((isset($lang['EDIT'])) ? $lang['EDIT'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'EDIT'))) . ' 	}')); ?>" /></a> &nbsp;&nbsp;
<?php }if ($this->_tpldata['.'][0]['AUTH_DELETE']) {  ?>  
		<a href="javascript:delete_file('<?php echo $this->_tpldata['.'][0]['U_DELETE']; ?>')"><img src="<?php echo $this->_tpldata['.'][0]['DELETE_IMG']; ?>" border="0" alt="<?php echo ((isset($this->_tpldata['.'][0]['L_DELETE'])) ? $this->_tpldata['.'][0]['L_DELETE'] : ((isset($lang['DELETE'])) ? $lang['DELETE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'DELETE'))) . ' 	}')); ?>" /></a>
<?php } ?>
	</th>
  </tr>
<tr> 
...
<?php if ($this->_tpldata['.'][0]['AUTH_DOWNLOAD']) {  ?>  
	<td width="33%" align="center"><a href="<?php echo $this->_tpldata['.'][0]['U_DOWNLOAD']; ?>"><img src="<?php echo $this->_tpldata['.'][0]['DOWNLOAD_IMG']; ?>" border="0" alt="<?php echo ((isset($this->_tpldata['.'][0]['L_DOWNLOAD'])) ? $this->_tpldata['.'][0]['L_DOWNLOAD'] : ((isset($lang['DOWNLOAD'])) ? $lang['DOWNLOAD'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'DOWNLOAD'))) . ' 	}')); ?>" /></a></td>
<?php }if ($this->_tpldata['.'][0]['AUTH_RATE']) {  ?>  
	<td width="34%" align="center"><a href="<?php echo $this->_tpldata['.'][0]['U_RATE']; ?>"><img src="<?php echo $this->_tpldata['.'][0]['RATE_IMG']; ?>" border="0" alt="<?php echo ((isset($this->_tpldata['.'][0]['L_RATE'])) ? $this->_tpldata['.'][0]['L_RATE'] : ((isset($lang['RATE'])) ? $lang['RATE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'RATE'))) . ' 	}')); ?>" /></a></td>
<?php }if ($this->_tpldata['.'][0]['AUTH_EMAIL']) {  ?>  
	<td width="33%" align="center"><a href="<?php echo $this->_tpldata['.'][0]['U_EMAIL']; ?>"><img src="<?php echo $this->_tpldata['.'][0]['EMAIL_IMG']; ?>" border="0" alt="<?php echo ((isset($this->_tpldata['.'][0]['L_EMAIL'])) ? $this->_tpldata['.'][0]['L_EMAIL'] : ((isset($lang['EMAIL'])) ? $lang['EMAIL'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'EMAIL'))) . ' 	}')); ?>" /></a></td>
<?php } ?>
  </tr>
</table>
<br />
