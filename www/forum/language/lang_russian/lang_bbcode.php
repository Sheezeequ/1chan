<?php
/***************************************************************************
 *                         lang_bbcode.php [Русский]
 *                            -------------------
 *   начало                : Среда Окт 3, 2001
 *   копирайт            : (C) 2001 The phpBB Group
...
$faq[] = array("--", "Другие материалы.");
$faq[] = array("Могу ли я добавлять собственные теги?", "Нет, боюсь, не уверен что это будет и в версии phpBB 2.0. Но Мы над этим работаем.");

//
// This ends the BBCode guide entries
//

$faq[] = array('Скрыть часть текста', "HIDE BBCode скрывает часть текста сообщения и оставляет ссылку для открытия его для прочтения. Пример:<br /><br /><b>[hide=Clickable text]</b>Hidden text<b>[/hide]</b><br /><br />will generate the following:<br /><br />\n<script language=\"javascript1.2\" type=\"text/javascript\">\n<!--\n   hideBBCode.open('Clickable text');\n//-->\n</script>\nHidden text\n<script language=\"javascript1.2\" type=\"text/javascript\">\n<!--\n   hideBBCode.close();\n//-->\n</script>\n<br />"); 
