<?php
/***************************************************************************
 *                          lang_faq.php [Русский]
 *                            -------------------
 *   начало               : Wednesday Oct 3, 2001
...
$faq[] = array("Что такое BBCode?", "BBCode это особая реализация HTML, возможность использования BBCode определяется администратором (вы также можете отключить его в каждом создаваемом вами сообщении). BBCode очень похож на HTML, тэги в нём заключаются в квадратные скобки [ и ], а не &lt; и &gt;, он даёт пользователю больше возможностей в создании сообщений. За дополнительной информацией о BBCode смотрите <a href=\"" . append_sid("faq.$phpEx?mode=bbcode") . "\" target=\"_phpbbcode\">руководство по BBCode</a>, ссылка на которое доступна из формы отправки сообщений.");
