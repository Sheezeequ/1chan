...
// eXtreme Styles mod cache. Generated on Mon, 29 Sep 2014 03:27:31 -0400 (time=1411975651)
...
<form method="post" action="<?php echo isset($this->vars['S_ATTACH_ACTION']) ? $this->vars['S_ATTACH_ACTION'] : $this->lang('S_ATTACH_ACTION'); ?>">
  <table width="99%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr align="right">
	  <td class="cat" colspan="5" height="29"> <?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?> <input type="submit" name="submit" class="liteoption" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" /></td>
	</tr>
	<tr>
		<th class="thCornerL"><?php echo isset($this->vars['L_DESCRIPTION']) ? $this->vars['L_DESCRIPTION'] : $this->lang('L_DESCRIPTION'); ?></th>
		<th class="thTop"><?php echo isset($this->vars['L_SIZE']) ? $this->vars['L_SIZE'] : $this->lang('L_SIZE'); ?></th>
...
?>
	<tr> 
	  ...
	  <tr>
		<td class="row1" align="center" valign="middle" width="10%" wrap="nowrap"><b><span class="gensmall"><a href="<?php echo isset($limit_row_item['U_VIEW']) ? $limit_row_item['U_VIEW'] : ''; ?>" class="gensmall"><?php echo isset($this->vars['L_VIEW']) ? $this->vars['L_VIEW'] : $this->lang('L_VIEW'); ?></a></span></b></td>
...
?>
	<tr align="right">
	  <td class="cat" colspan="5" height="29"> <input type="submit" name="submit" class="liteoption" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" /></td>
	</tr>
</table>
</form>
