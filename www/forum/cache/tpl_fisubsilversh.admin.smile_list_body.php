...
// eXtreme Styles mod cache. Generated on Sat, 10 Dec 2011 10:29:05 -0500 (time=1323530945)

?><div class="maintitle"><?php echo isset($this->vars['L_SMILEY_TITLE']) ? $this->vars['L_SMILEY_TITLE'] : $this->lang('L_SMILEY_TITLE'); ?></div>
<br />
<div class="genmed"><?php echo isset($this->vars['L_SMILEY_TEXT']) ? $this->vars['L_SMILEY_TEXT'] : $this->lang('L_SMILEY_TEXT'); ?></div>
<br />
...
<tr> 
<th><?php echo isset($this->vars['L_CODE']) ? $this->vars['L_CODE'] : $this->lang('L_CODE'); ?></th>
<th><?php echo isset($this->vars['L_SMILE']) ? $this->vars['L_SMILE'] : $this->lang('L_SMILE'); ?></th>
<th><?php echo isset($this->vars['L_EMOT']) ? $this->vars['L_EMOT'] : $this->lang('L_EMOT'); ?></th>
...
<td class="<?php echo isset($smiles_item['ROW_CLASS']) ? $smiles_item['ROW_CLASS'] : ''; ?>" align="center"><img src="<?php echo isset($smiles_item['SMILEY_IMG']) ? $smiles_item['SMILEY_IMG'] : ''; ?>" alt="<?php echo isset($smiles_item['CODE']) ? $smiles_item['CODE'] : ''; ?>" title="<?php echo isset($smiles_item['CODE']) ? $smiles_item['CODE'] : ''; ?>" /></td>
...
?>
<tr> 
<td class="cat" colspan="5" align="center"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?> 
<input type="submit" name="add" value="<?php echo isset($this->vars['L_SMILEY_ADD']) ? $this->vars['L_SMILEY_ADD'] : $this->lang('L_SMILEY_ADD'); ?>" class="mainoption" />
&nbsp;&nbsp; 
<input class="button" type="submit" name="import_pack" value="<?php echo isset($this->vars['L_IMPORT_PACK']) ? $this->vars['L_IMPORT_PACK'] : $this->lang('L_IMPORT_PACK'); ?>" />
&nbsp;&nbsp; 
<input class="button" type="submit" name="export_pack" value="<?php echo isset($this->vars['L_EXPORT_PACK']) ? $this->vars['L_EXPORT_PACK'] : $this->lang('L_EXPORT_PACK'); ?>" />
</td>
</tr>
</table>
</form>
