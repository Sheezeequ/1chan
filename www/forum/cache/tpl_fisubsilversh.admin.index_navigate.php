...
// eXtreme Styles mod cache. Generated on Tue, 29 Nov 2022 16:06:56 +0300 (time=1669727216)

?><table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr> 
<td align="center" ><a href="<?php echo isset($this->vars['U_FORUM_INDEX']) ? $this->vars['U_FORUM_INDEX'] : $this->lang('U_FORUM_INDEX'); ?>" target="_parent"><img src="../templates/fisubsilversh/images/logo_phpbb_med.gif" alt="" width="122" height="56" vspace="4" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
...
<tr> 
<th><?php echo isset($this->vars['L_ADMIN']) ? $this->vars['L_ADMIN'] : $this->lang('L_ADMIN'); ?></th>
</tr>
<tr> 
<td class="row1"><a href="<?php echo isset($this->vars['U_ADMIN_INDEX']) ? $this->vars['U_ADMIN_INDEX'] : $this->lang('U_ADMIN_INDEX'); ?>" target="main" class="genmed"><?php echo isset($this->vars['L_ADMIN_INDEX']) ? $this->vars['L_ADMIN_INDEX'] : $this->lang('L_ADMIN_INDEX'); ?></a></td>
</tr>
<tr> 
<td class="row1"><a href="<?php echo isset($this->vars['U_FORUM_INDEX']) ? $this->vars['U_FORUM_INDEX'] : $this->lang('U_FORUM_INDEX'); ?>" target="_parent" class="genmed"><?php echo isset($this->vars['L_FORUM_INDEX']) ? $this->vars['L_FORUM_INDEX'] : $this->lang('L_FORUM_INDEX'); ?></a></td>
</tr>
<tr> 
<td class="row1"><a href="<?php echo isset($this->vars['U_FORUM_INDEX']) ? $this->vars['U_FORUM_INDEX'] : $this->lang('U_FORUM_INDEX'); ?>" target="main" class="genmed"><?php echo isset($this->vars['L_PREVIEW_FORUM']) ? $this->vars['L_PREVIEW_FORUM'] : $this->lang('L_PREVIEW_FORUM'); ?></a></td>
</tr>
<tr> 
<td class="row1"><a href="<?php echo isset($this->vars['U_PORTAL_INDEX']) ? $this->vars['U_PORTAL_INDEX'] : $this->lang('U_PORTAL_INDEX'); ?>" target="_parent" class="genmed"><?php echo isset($this->vars['L_PORTAL_INDEX']) ? $this->vars['L_PORTAL_INDEX'] : $this->lang('L_PORTAL_INDEX'); ?></a></td>
</tr>
<tr> 
<td class="row1"><a href="<?php echo isset($this->vars['U_PORTAL_PREVIEW']) ? $this->vars['U_PORTAL_PREVIEW'] : $this->lang('U_PORTAL_PREVIEW'); ?>" target="main" class="genmed"><?php echo isset($this->vars['L_PREVIEW_PORTAL']) ? $this->vars['L_PREVIEW_PORTAL'] : $this->lang('L_PREVIEW_PORTAL'); ?></a></td>
</tr>
<tr> 
...
?>
<tr> 
<td align="center" class="cat" style="cursor:pointer;cursor:hand;" onclick="onMenuCatClick('<?php echo isset($catrow_item['MENU_CAT_ID']) ? $catrow_item['MENU_CAT_ID'] : ''; ?>');"><span class="genmed"><?php echo isset($catrow_item['ADMIN_CATEGORY']) ? $catrow_item['ADMIN_CATEGORY'] : ''; ?></span></td>
</tr>
<tr>
			<td class="row1">
