...
// eXtreme Styles mod cache. Generated on Mon, 29 Sep 2014 03:26:51 -0400 (time=1411975611)
...
?>
	<tr>
		<td class="cat" colspan="2" align="center"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?><input type="submit" name="submit" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="<?php echo isset($this->vars['L_RESET']) ? $this->vars['L_RESET'] : $this->lang('L_RESET'); ?>" class="liteoption" />&nbsp;&nbsp;<input type="submit" name="settings" value="<?php echo isset($this->vars['L_TEST_SETTINGS']) ? $this->vars['L_TEST_SETTINGS'] : $this->lang('L_TEST_SETTINGS'); ?>" class="liteoption" /></td>
	</tr>
</table></form>
