...
// eXtreme Styles mod cache. Generated on Sat, 10 Dec 2011 10:28:55 -0500 (time=1323530935)
...
<tr>
	...
	<th align="center"><?php echo isset($this->vars['L_PERMISSIONS']) ? $this->vars['L_PERMISSIONS'] : $this->lang('L_PERMISSIONS'); ?></th>
	<th align="center"><?php echo isset($this->vars['L_DEFAULT']) ? $this->vars['L_DEFAULT'] : $this->lang('L_DEFAULT'); ?></th>
	<th align="center"><?php echo isset($this->vars['L_USAGE']) ? $this->vars['L_USAGE'] : $this->lang('L_USAGE'); ?></th>
	<th align="center" colspan="2"><?php echo isset($this->vars['L_ACTION']) ? $this->vars['L_ACTION'] : $this->lang('L_ACTION'); ?></th>
</tr>
<?php
...
?>
<tr>
	<td class="row1" width="20" align="center"><span class="genmed"><?php echo isset($row_item['ICON']) ? $row_item['ICON'] : ''; ?></span></td>
	<td class="row1"><span class="gen"><?php echo isset($row_item['L_LANG']) ? $row_item['L_LANG'] : ''; ?></span><span class="gensmall"><?php echo isset($row_item['LANG_KEY']) ? $row_item['LANG_KEY'] : ''; ?></span></td>
...
?>
			<?php echo isset($default_item['L_DEFAULT']) ? $default_item['L_DEFAULT'] : ''; ?><br />
			<?php
...
?>
<tr>
	<td class="cat" colspan="7" align="center"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?>
		<input type="submit" name="create" class="mainoption" value="<?php echo isset($this->vars['L_CREATE']) ? $this->vars['L_CREATE'] : $this->lang('L_CREATE'); ?>" />
	</td>
</tr>
</table>
</form>