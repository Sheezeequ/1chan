...
// eXtreme Styles mod cache. Generated on Mon, 29 Sep 2014 03:34:01 -0400 (time=1411976041)
...
<br />
<div class="subtitle"> <?php echo isset($this->vars['L_FORUM']) ? $this->vars['L_FORUM'] : $this->lang('L_FORUM'); ?>: <?php echo isset($this->vars['FORUM_NAME']) ? $this->vars['FORUM_NAME'] : $this->lang('FORUM_NAME'); ?></div>
<br />
...
?>
<th><?php echo isset($forum_auth_titles_item['CELL_TITLE']) ? $forum_auth_titles_item['CELL_TITLE'] : ''; ?></th>
<?php
