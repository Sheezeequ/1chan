...
// eXtreme Styles mod cache. Generated on Thu, 18 Jun 2015 01:11:15 -0400 (time=1434604275)
...
?>
	  <td width="100%" nowrap="nowrap" valign="top">
		...
		<tr>
			  <th class="thHead" nowrap="nowrap" align="left" colspan="2">&nbsp;<?php echo isset($this->vars['L_LINK_TITLE1']) ? $this->vars['L_LINK_TITLE1'] : $this->lang('L_LINK_TITLE1'); ?></th>
		</tr>
		<tr>
			  <form method="post" action="<?php echo isset($this->vars['U_SITE_SEARCH']) ? $this->vars['U_SITE_SEARCH'] : $this->lang('U_SITE_SEARCH'); ?>">
			  <td class="cat" align="right" nowrap="nowrap" colspan="2"><span class="genmed">
			  <?php echo isset($this->vars['L_SEARCH_SITE_TITLE']) ? $this->vars['L_SEARCH_SITE_TITLE'] : $this->lang('L_SEARCH_SITE_TITLE'); ?><input type="text" style="width: 200px" class="post" name="search_keywords" size="30" />&nbsp;<input type="submit" name="submit" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" class="catbutton" />&nbsp;</span></td>
			  </form>
		</tr>
		<?php
