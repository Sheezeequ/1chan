...
// eXtreme Styles mod cache. Generated on Mon, 12 Dec 2011 11:00:00 -0500 (time=1323705600)
...
?>
	...
	<tr>
		<td class="cat" colspan="2" align="center"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?><input type="submit" name="submit" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="<?php echo isset($this->vars['L_RESET']) ? $this->vars['L_RESET'] : $this->lang('L_RESET'); ?>" class="liteoption" />&nbsp;&nbsp;<input type="submit" name="search_imagick" value="<?php echo isset($this->vars['L_SEARCH_IMAGICK']) ? $this->vars['L_SEARCH_IMAGICK'] : $this->lang('L_SEARCH_IMAGICK'); ?>" class="liteoption" />&nbsp;&nbsp;<input type="submit" name="cat_settings" value="<?php echo isset($this->vars['L_TEST_SETTINGS']) ? $this->vars['L_TEST_SETTINGS'] : $this->lang('L_TEST_SETTINGS'); ?>" class="liteoption" /></td>
	</tr>
</table></form>
