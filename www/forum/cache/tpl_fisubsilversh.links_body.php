...
// eXtreme Styles mod cache. Generated on Thu, 18 Jun 2015 07:44:51 -0400 (time=1434627891)
		...
		<table border="0" cellpadding="2" cellspacing="0" width="100%">
			...
			<tr> 
			  <td class="row1">
				...
				<select name="link_category" style="width:160px"><?php echo isset($this->vars['LINK_CAT_OPTION']) ? $this->vars['LINK_CAT_OPTION'] : $this->lang('LINK_CAT_OPTION'); ?></select>
			  </td>
			</tr>
			<tr> 
...
?>
	  <td width="100%" nowrap="nowrap" valign="top">
		...
		<tr>
			  <th class="thHead" align="left" nowrap="nowrap" colspan="2">&nbsp;<?php echo isset($this->vars['L_LINK_CATEGORY']) ? $this->vars['L_LINK_CATEGORY'] : $this->lang('L_LINK_CATEGORY'); ?> &raquo; <?php echo isset($this->vars['LINK_CATEGORY']) ? $this->vars['LINK_CATEGORY'] : $this->lang('LINK_CATEGORY'); ?></th>
		</tr>
		<tr>
			  <form method="post" action="<?php echo isset($this->vars['U_SITE_LINKS']) ? $this->vars['U_SITE_LINKS'] : $this->lang('U_SITE_LINKS'); ?>">
			  <td class="cat" align="right" nowrap="nowrap" colspan="2"><span class="genmed"><?php echo isset($this->vars['L_SELECT_SORT_METHOD']) ? $this->vars['L_SELECT_SORT_METHOD'] : $this->lang('L_SELECT_SORT_METHOD'); ?>:<?php echo isset($this->vars['S_MODE_SELECT']) ? $this->vars['S_MODE_SELECT'] : $this->lang('S_MODE_SELECT'); ?>&nbsp;<?php echo isset($this->vars['L_ORDER']) ? $this->vars['L_ORDER'] : $this->lang('L_ORDER'); ?>:<?php echo isset($this->vars['S_ORDER_SELECT']) ? $this->vars['S_ORDER_SELECT'] : $this->lang('S_ORDER_SELECT'); ?>&nbsp;<input type="submit" name="submit" value="<?php echo isset($this->vars['L_SORT']) ? $this->vars['L_SORT'] : $this->lang('L_SORT'); ?>" class="catbutton" />&nbsp;</span></td>
			  </form>
		</tr>
		<?php
...
?>
		...
		<tr>
		<td class="<?php echo isset($linkrow_item['ROW_CLASS']) ? $linkrow_item['ROW_CLASS'] : ''; ?>" align="center"><span class="genmed"><?php echo isset($this->vars['L_LINK_JOINED']) ? $this->vars['L_LINK_JOINED'] : $this->lang('L_LINK_JOINED'); ?>: <?php echo isset($linkrow_item['LINK_JOINED']) ? $linkrow_item['LINK_JOINED'] : ''; ?>&nbsp;&nbsp;,&nbsp;<?php echo isset($this->vars['L_LINK_HITS']) ? $this->vars['L_LINK_HITS'] : $this->lang('L_LINK_HITS'); ?>: <?php echo isset($linkrow_item['LINK_HITS']) ? $linkrow_item['LINK_HITS'] : ''; ?>&nbsp;&nbsp;,&nbsp;<?php echo isset($this->vars['L_LINK_SUBMITER']) ? $this->vars['L_LINK_SUBMITER'] : $this->lang('L_LINK_SUBMITER'); ?>&nbsp;<?php echo isset($linkrow_item['U_LINK_USER']) ? $linkrow_item['U_LINK_USER'] : ''; ?></span></td>
		</tr>
		<?php
